...
document.getElementById("rightBox").innerHTML += "<button class='fbbutton confirm' id='fbLogout' onclick='fbLogout()'>Logout</button>";function fbLogout() {
    ...
    <?php } else { ?>
      <!-- <p>Not Logged into Facebook</p> -->
			<script>
			document.getElementById("rightBox").innerHTML += "<br><fb:login-button scope ='publish_stream, friends_games_activity, user_games_activity, publish_actions'></fb:login-button>";
			</script>
	  <?php } ?>
        ...
        FB.Event.subscribe('auth.login', function(response) {
          ...
          (function(d){
           ...
           var obj = {
           	...
           	caption: '' + UserName + ' beat their high score in Cabin Crashers!',
           	description: '' + UserName + ' got ' + scoreToPost + ' points and beat their high score! Can you top that?'
			...
			<?php if($userId){ ?>
				...
				<br>
					...
					repair ability, so the more people you get to try the game, the higher chance of getting a "starred" player in your crew!
						...
						<h2 class="mainfont" style="margin-bottom:0px;"> <i>Brought to you by <b>Banjo Bear Studios</b></i>: </h2>
				...
				<div style="clear:left;"><iframe src = "https://www.facebook.com/plugins/like.php?href=http://game.courses.asu.edu/"
